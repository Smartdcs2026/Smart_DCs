...
/***********************
 * SweetAlert QR — Mobile First + Logo
 ***********************/
function buildQrPopupHtmlV5({
...
<style>
  ...
  @media (max-width:480px){
    .mqr-card{ max-width:100%; border-radius:20px; }
    .mqr-logo{ max-width:120px; max-height:42px; }
    .mqr-title{ font-size:18px; }
    .mqr-sub{ font-size:11.5px; }
    .mqr-qr-box{ width:min(68vw, 220px); padding:9px; border-radius:14px; }
    .mqr-id-code{ font-size:15px; }
    .mqr-v{ font-size:11.5px; }
    .mqr-btn{ min-height:44px; font-size:13.5px; }
  }
</style>
  ...
  <div class="mqr-card" id="qrCardCapture">
    <div class="mqr-head">
      <div class="mqr-logo-wrap">
        <img class="mqr-logo" src="${escapeHtml(logoUrl || '')}" alt="Company Logo">
      </div>
      <div class="mqr-badge">VISITOR PASS</div>
      <h2 class="mqr-title">QR สำหรับสแกนออก</h2>
      <p class="mqr-sub">กรุณาแสดง QR นี้ต่อเจ้าหน้าที่เมื่อออกจากพื้นที่</p>
